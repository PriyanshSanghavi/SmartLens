...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        builder.setTitle("Set Document image");

        // add a list
        String[] images = {"Take a picture", "Choose from gallery"};
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.DriverThemColor));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.DriverThemColor));
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.DriverThemColor));
