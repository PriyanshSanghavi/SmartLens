...
$driver = $ratting =0;
Static $lp=0,$lr=0,$tl=0;
$q="select * from traffic_police where ps_id = $ps_id";
$rs=mysqli_query($cn,$q);	
while($tpolice=mysqli_fetch_array($rs))
{ 
	$tp_id = $tpolice['tp_id'];
	$q3 = "select * from tp_leave where tp_id = '$tp_id'";
	$resu=mysqli_query($cn,$q3);
	$tl=$tl + mysqli_num_rows($resu);
	$q1 = "select * from tp_leave where tp_id = '$tp_id' && permission = 'pending'";
	$res=mysqli_query($cn,$q1);
	$lp=$lp + mysqli_num_rows($res);
	$q2 = "select * from tp_leave where tp_id = '$tp_id' && permission != 'pending'";
	$result=mysqli_query($cn,$q2);
	$lr=$lr + mysqli_num_rows($result);
}
...
<body class="dashboard-page">
	<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				<a href="javascript:;">
				<i style="padding:20px;font-size:20px" class="fa fa-address-card"></i>
				<span class="nav-text">
					Traffic Police
				</span>
				...
				<ul>
					<li>
					<a class="subnav-text" href="add_tpolice.php">
					Add
					</a>
					</li>
					<li>
					<a class="subnav-text" href="viewtrafficpolice.php">
					Edit  OR  View
					</a>
					</li>
				</ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
						<a class="subnav-text" href="reply_request.php">
							Reply Request
						</a>
					</li>
					<li>
							...
							<li class="dropdown head-dpdn">
								...
								<ul class="dropdown-menu anti-dropdown-menu agile-task">
									<li><a href="ratting.php">
										<div class="task-info">
											<span class="task-desc">Application Rating</span><span class="percentage"><?php echo get_percentage($driver,$ratting).'%'; ?></span>
											<div class="clearfix"></div>	
										</div>
									...
									<li><a href="tpoliceleave.php">
										<div class="task-info">
											<span class="task-desc">Successful Leave Reply</span><span class="percentage"><?php echo get_percentage($tl,$lr).'%'; ?></span>
										   <div class="clearfix"></div>	
										</div>
										<div class="progress progress-striped active">
											 <div class="bar green" style="width:<?php echo get_percentage($tl,$lr).'%'; ?>;"></div>
										</div>
									</a></li>
									<li><a href="reply_request.php">
										<div class="task-info">
											<span class="task-desc">Pending Leave Reply</span><span class="percentage"><?php echo get_percentage($tl,$lp).'%'; ?></span>
											<div class="clearfix"></div>	
										</div>
									   <div class="progress progress-striped active">
											 <div class="bar yellow" style="width: <?php echo get_percentage($tl,$lp).'%'; ?>;"></div>
										</div>
									</a></li>
								</ul>
							</li>	
						...
						<ul>
							<li class="dropdown profile_details_drop">
								...
								<ul class="dropdown-menu drp-mnu">
									<li> <a href="branch_Profile.PHP"><i class="fa fa-user"></i> Profile</a> </li> 
