...
{	
	...
	$tp_id=$tp['tp_id'];
	$name=$tp['name'];
	header("location:tpoliceleave.php?tpolice=$result&tp_id=$tp_id&tname=$name&ps=$ps&fromdate=$fromdate&todate=$todate");
	}
else
{
	header("location:tpoliceleave.php?tpolice=$result&fromdate=$fromdate&todate=$todate&msg=failed");
}
?>